...
public class JkTradeReceiveExceptionController {
    ...
    public CommonResult<JkTradeReceiveExceptionDetailResponse> report(
            @RequestBody @Validated JkTradeReceiveExceptionCreateRequest request) {
    ...
    public CommonResult<JkTradeReceiveExceptionDetailResponse> detailByBusiness(

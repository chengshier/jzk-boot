...
@RestController
@RequestMapping("api/admin/jk/performance")
public class JkPerformanceAdminController {
    ...
    public CommonResult<CommonPage<JkPerformanceRecord>> list(@RequestParam(required = false) Long ownerUserId,

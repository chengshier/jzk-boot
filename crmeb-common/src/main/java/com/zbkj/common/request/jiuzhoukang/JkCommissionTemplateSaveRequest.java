...
public class JkCommissionTemplateSaveRequest implements Serializable {
    ...
    private Long ruleId;
    @NotNull(message = "商业方案不能为空") private Long planId;
    @NotBlank(message = "奖励模板不能为空") private String templateCode;
    @NotBlank(message = "规则名称不能为空") private String ruleName;
    @NotBlank(message = "适用受益身份不能为空") private String receiverRoleCode;
    @NotBlank(message = "奖励方式不能为空") private String rewardMode;

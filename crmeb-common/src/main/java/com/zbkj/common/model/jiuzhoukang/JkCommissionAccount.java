...
@Data @Accessors(chain = true) @TableName("jk_commission_account")
public class JkCommissionAccount implements Serializable {
    @TableId(value = "id", type = IdType.AUTO) private Long id;
    private String accountNo; private Long userId; private String roleCode; private String regionCode;
    private BigDecimal pendingSettleAmount; private BigDecimal settledAmount; private BigDecimal frozenCommissionAmount;
    private BigDecimal reversedAmount; private BigDecimal totalCommissionAmount; private BigDecimal negativeOffsetAmount;

...
@TableName("jk_stock_transfer")
public class JkStockTransfer {
    @TableId(value = "id", type = IdType.AUTO) private Long id;
    private String transferNo; private String requestNo; private Long userId; private String roleCode; private Long countyAgentId; private String regionCode;
    private String status; private String payStatus; private String auditStatus; private String receiveStatus; private BigDecimal totalAmount;
